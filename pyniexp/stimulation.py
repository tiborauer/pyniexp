...
"""
from pyES import Waveform, Stimulator
...
wave1 = Waveform(amplitude = 1, frequency = 10, phase=0, duration = 20, rampUp = 4, rampDown = 4, samplingRate = 1000)
wave2 = Waveform(amplitude = 1, frequency = 10, phase=phase, duration = 20, rampUp = 4, rampDown = 4, samplingRate = 1000)
